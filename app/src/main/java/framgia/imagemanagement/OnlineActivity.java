...
public class OnlineActivity extends Activity {
    ...
    public void setFindViewById() {
        ...
        // set up event when scroll the gridView
...
//                    }
                ...
                case R.id.online_search_button:
                    ...
                    if (!strSearch.equals("")) {
                        // init value for new searching key work
                        startIndex = 0;
                        currentPage = 0;
                        previousTotal = 0;
                        isLoading = true;
                        ...
                        (new OnlineActivity.getImagesTask()).execute();
                        (new OnlineActivity.getImagesTask()).execute();
    ...
    public class getImagesTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            this.dialog =
                ProgressDialog.show(OnlineActivity.this, "", getString(R.string.wait_msg));
        }
        ...
        protected void onPostExecute(Void result) {
            ...
            Log.e("size of list of image>>", "" + listImageObj.size());
        }
        ...
        public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount,
            ...
            if (isLoading) {
                if (totalItemCount > previousTotal) {
                    ...
                    currentPage++;
                    Log.e("______currentP______", "" + currentPage);
